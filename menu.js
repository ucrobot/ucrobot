class linkConnect {
	...
	indexRobotkitEqDuino() {
		var varHome = new String('https://ucrobot.github.io/');
		var varIndex = varHome + 'eq-duino/eq-duino.html';
		location.href = varIndex;
	}
}
...
document.write(`
<header>
	<h1><a href="javascript:link.index()" style="background-color: #4d6c8b; color:white; text-align:center;background-color: #4d6c8b;">
		Robot Study</a></h1>
	<p style="padding-bottom: 1rem; text-align:center;background-color: #4d6c8b;">
		Roboting Everyone</p>
  <div id="menu">
    <ul class="main">
      ...
      <li><a href="javascript:link.indexRobotkit()">Robot kit</a>
        <ul class="sub">
          <li><a href="javascript:link.indexRobotkitP()">PreK ~ K</a></li>
					...
					<li><a href="javascript:link.indexRobotkitEqDuino()">&nbsp;&nbsp;- EQ-DUINO</a></li>
